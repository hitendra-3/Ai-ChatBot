...
const Api_Url="https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=AIzaSyDTFFQoq3KTjg9F25Qqdgrx9pMQyBD0xkA"
...
let text=aiChatBox.querySelector(".ai-chat-area")
    ...
    try{
        ...
        let formattedResponse = apiResponse
            ...
            .replace(/^(\*\s+)(.*?)$/gm, '<div class="bullet-item"><span class="bullet">•</span><span class="content">$2</span></div>')
            .replace(/\n\n/g, '</p><p>')
            .replace(/\n/g, '<br>')
